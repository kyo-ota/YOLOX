...
ODGT_PATH = '../input/crowdhumanwith-coco-labels/'
...
if __name__ == '__main__':
    ...
    for split in SPLITS:
        ...
        ann_path = ODGT_PATH + 'annotation_{}.odgt'.format(split)
        ...
        for ann_data in anns_data:
            image_cnt += 1
            file_path = DATA_PATH + 'images_{}/'.format(split) + '{}.jpg'.format(ann_data['ID'])
